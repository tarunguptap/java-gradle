...
public class InitializerHelper {
    ...
    public static List<Employee> getEmployeeList() {
        ...
        Employee employee2 = new Employee(2L, "emp2", "FINANCE");
        Employee employee3 = new Employee(3L, "emp3", "SECURITY");
        Employee employee4 = new Employee(4L, "emp4", "DEV");
        Employee employee5 = new Employee(5L, "emp5", "ANONYMOUS", false);
        return Arrays.asList(employee1, employee2, employee3, employee4, employee5);
    }

    public static Map<String, Employee> getEmployeeMap() {
        return InitializerHelper.getEmployeeList().stream()
