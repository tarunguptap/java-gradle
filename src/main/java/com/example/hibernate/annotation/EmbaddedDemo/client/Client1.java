package com.example.hibernate.annotation.EmbaddedDemo.client;
...
import com.example.hibernate.annotation.EmbaddedDemo.model.AuditInfo;
import com.example.hibernate.annotation.EmbaddedDemo.model.Customer;
...
public class Client1 {
	...
	public static void main(String[] args) 
	{
		try
		{
			ApplicationContext context = new ClassPathXmlApplicationContext("com/example/hibernate/annotation/EmbaddedDemo/cfg/applicationContext.xml");
			...
			Customer cust = new Customer("1", "tarun","gupta", "87787","45545",auditInfo,true);
