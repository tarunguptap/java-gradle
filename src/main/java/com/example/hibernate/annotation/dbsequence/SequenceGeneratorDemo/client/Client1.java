package com.example.hibernate.annotation.dbsequence.SequenceGeneratorDemo.client;
...
import com.example.hibernate.annotation.dbsequence.SequenceGeneratorDemo.model.Customer;
...
public class Client1 {
	...
	public static void main(String[] args) 
	{
		try
		{
			ApplicationContext context = new ClassPathXmlApplicationContext("com/example/hibernate/annotation/dbsequence/SequenceGeneratorDemo/cfg/applicationContext.xml");
