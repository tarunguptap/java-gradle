...
@Entity
@Table(name = "CUSTOMER_INFO_SEQ_GENERATOR")
@AttributeOverride(name = "id", column = @Column(name = "CUSTOMER_ID"))
@GenericGenerator (name = "demo_generator", strategy = "seqhilo", parameters = {@Parameter(name = "max_lo", value = "1"), @Parameter(name = "sequence", value = "customer_seq")})
public class Customer extends PersistentEntity {
	...
	*/
	...
	public Customer(String userId,String firstname,String lastname,String mobnum,String offphone,Boolean active){
